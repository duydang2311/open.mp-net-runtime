...
DLL_EXPORT void TextDrawBase_SetColour(ITextDrawBase* td, Colour colour);
DLL_EXPORT Colour TextDrawBase_GetLetterColour(const ITextDrawBase* td);
DLL_EXPORT void TextDrawBase_UseBox(ITextDrawBase* td, bool use);
DLL_EXPORT bool TextDrawBase_HasBox(ITextDrawBase* td);
DLL_EXPORT void TextDrawBase_SetBoxColour(ITextDrawBase* td, Colour colour);
DLL_EXPORT Colour TextDrawBase_GetBoxColour(const ITextDrawBase* td);
...
DLL_EXPORT void TextDrawBase_SetBackgroundColour(ITextDrawBase* td, Colour colour);
DLL_EXPORT Colour TextDrawBase_GetBackgroundColour(const ITextDrawBase* td);
...
DLL_EXPORT void Player_BeginSelection(IEntity* player, Colour highlight);
DLL_EXPORT bool Player_IsSelecting(const IEntity* player);
