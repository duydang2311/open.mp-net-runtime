...
DLL_EXPORT bool Player_IsStreamedInFor(int playerid, int forplayerid);
...
DLL_EXPORT bool Player_SetColor(int playerid, uint32_t argb);
...
DLL_EXPORT bool Player_GetIp(int playerid, char* ip, std::size_t size);
...
DLL_EXPORT void Player_GetName(int playerid, char* name, std::size_t size);
...
DLL_EXPORT int Player_CreatePreviewModelTextDraw(int playerid, float x, float y, int model);
DLL_EXPORT bool Player_DestroyTextDraw(int playerid, int textid);
DLL_EXPORT bool Player_GetTextDrawPosition(int playerid, int textid, float* x, float* y);
DLL_EXPORT bool Player_GetTextDrawLetterSize(int playerid, int textid, float* x, float* y);
DLL_EXPORT bool Player_GetTextDrawTextSize(int playerid, int textid, float* x, float* y);
DLL_EXPORT int Player_GetTextDrawAlignment(int playerid, int textid);
DLL_EXPORT uint32_t Player_GetTextDrawColor(int playerid, int textid);
DLL_EXPORT bool Player_TextDrawHasBox(int playerid, int textid);
DLL_EXPORT uint32_t Player_GetTextDrawBoxColor(int playerid, int textid);
DLL_EXPORT int Player_GetTextDrawShadow(int playerid, int textid);
DLL_EXPORT int Player_GetTextDrawOutline(int playerid, int textid);
DLL_EXPORT uint32_t Player_GetTextDrawBackgroundColor(int playerid, int textid);
DLL_EXPORT int Player_GetTextDrawStyle(int playerid, int textid);
DLL_EXPORT bool Player_IsTextDrawProportional(int playerid, int textid);
DLL_EXPORT bool Player_IsTextDrawSelectable(int playerid, int textid);
DLL_EXPORT bool Player_GetTextDrawText(int playerid, int textid, char* text, std::size_t size);
DLL_EXPORT int Player_GetTextDrawPreviewModel(int playerid, int textid);
DLL_EXPORT bool Player_GetTextDrawPreviewRotation(int playerid, int textid, float* rot_x, float* rot_y, float* rot_z);
DLL_EXPORT float Player_GetTextDrawPreviewZoom(int playerid, int textid);
DLL_EXPORT int Player_GetTextDrawPreviewVehiclePrimaryColor(int playerid, int textid);
DLL_EXPORT int Player_GetTextDrawPreviewVehicleSecondaryColor(int playerid, int textid);
DLL_EXPORT bool Player_SetTextDrawPosition(int playerid, int textid, float x, float y);
DLL_EXPORT bool Player_SetTextDrawLetterSize(int playerid, int textid, float x, float y);
DLL_EXPORT bool Player_SetTextDrawTextSize(int playerid, int textid, float x, float y);
DLL_EXPORT bool Player_SetTextDrawAlignment(int playerid, int textid, int alignment);
DLL_EXPORT bool Player_SetTextDrawColor(int playerid, int textid, uint32_t argb);
DLL_EXPORT bool Player_SetTextDrawUseBox(int playerid, int textid, bool use);
DLL_EXPORT bool Player_SetTextDrawBoxColor(int playerid, int textid, uint32_t argb);
DLL_EXPORT bool Player_SetTextDrawShadow(int playerid, int textid, int size);
DLL_EXPORT bool Player_SetTextDrawOutline(int playerid, int textid, int size);
DLL_EXPORT bool Player_SetTextDrawBackgroundColor(int playerid, int textid, uint32_t argb);
DLL_EXPORT bool Player_SetTextDrawStyle(int playerid, int textid, int style);
DLL_EXPORT bool Player_SetTextDrawProportional(int playerid, int textid, bool proportional);
DLL_EXPORT bool Player_SetTextDrawSelectable(int playerid, int textid, bool selectable);
DLL_EXPORT bool Player_ShowTextDraw(int playerid, int textid);
DLL_EXPORT bool Player_HideTextDraw(int playerid, int textid);
DLL_EXPORT bool Player_SetTextDrawText(int playerid, int textid, const char* text);
DLL_EXPORT bool Player_SetTextDrawPreviewModel(int playerid, int textid, int model);
DLL_EXPORT bool Player_SetTextDrawPreviewRotation(int playerid, int textid, float rot_x, float rot_y, float rot_z);
DLL_EXPORT bool Player_SetTextDrawPreviewZoom(int playerid, int textid, float zoom);
DLL_EXPORT bool Player_SetTextDrawPreviewVehiclePrimaryColor(int playerid, int textid, int color);
DLL_EXPORT bool Player_SetTextDrawPreviewVehicleSecondaryColor(int playerid, int textid, int color);
DLL_EXPORT bool Player_RestreamTextDraw(int playerid, int textid);
...
DLL_EXPORT bool Player_GetPVarString(int playerid, const char* varname, char* value, std::size_t size);
...
DLL_EXPORT bool Player_GetPVarNameAtIndex(int playerid, int index, char* varname, std::size_t size);
...
DLL_EXPORT bool Player_SetMapIcon(int playerid, int iconid, float x, float y, float z, int markertype, uint32_t argb, int style = MapIconStyle::MapIconStyle_Local);
...
DLL_EXPORT bool Player_EnableStuntBonus(int playerid, bool enable);
